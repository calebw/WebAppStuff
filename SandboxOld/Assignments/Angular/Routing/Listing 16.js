angular.module("exampleApp", ["ngResource","ngRoute"])
    .constant("baseUrl", "http://localhost:8080/JSONP/rest/products")
    .config(function($routeProvider,$locationProvider){
        $locationProvider.html5Mode(true);
        $routeProvider.when("/list",{templateUrl:"Listing 09.html"});
        $routeProvider.when("/edit/:id",{templateUrl:"editorView.html"});
        $routeProvider.when("/edit/:id/:data*",{templateUrl: "editorView.html"});
        $routeProvider.when("/create",{templateUrl:"editorView.html"});
        $routeProvider.otherwise({templateUrl:"Listing 09.html"});
    })
